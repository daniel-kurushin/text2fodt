...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 25 16:24:19 2019
...
def image(soup, number, name):
    ...
    for suff in ['jpeg','png','jpg']:
        imname = '/home/dan/src/engine-neuro-ident/img/%s.%s' % (name, suff)
        try:
...
doc = BS(open('in.fodt').read(), features='lxml')
